...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-11-2019 a las 18:14:33
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `nel` ()  begin
select * from tbl_name where ane = 'no';
end$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `orden` ()  begin
select * from tbl_name order by age;
end$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `simon` ()  begin
select * from tbl_name where ane = 'yes';
end$$
...
CREATE TABLE `tbl_name` (
  ...
  `bp` varchar(14) DEFAULT NULL,
  `sg` varchar(16) DEFAULT NULL,
  `al` varchar(7) DEFAULT NULL,
  `su` varchar(5) DEFAULT NULL,
  `rbc` varchar(15) DEFAULT NULL,
  `pc` varchar(8) DEFAULT NULL,
  `pcc` varchar(15) DEFAULT NULL,
  `ba` varchar(10) DEFAULT NULL,
  `bgr` varchar(20) DEFAULT NULL,
  `bu` varchar(10) DEFAULT NULL,
  `sc` varchar(16) DEFAULT NULL,
  `sod` varchar(6) DEFAULT NULL,
  `pot` varchar(9) DEFAULT NULL,
  `hemo` varchar(10) DEFAULT NULL,
  `pcv` varchar(18) DEFAULT NULL,
  `wc` varchar(22) DEFAULT NULL,
  `rc` varchar(20) DEFAULT NULL,
  `htn` varchar(12) DEFAULT NULL,
  `dm` varchar(17) DEFAULT NULL,
  `cad` varchar(23) DEFAULT NULL,
  `appet` varchar(8) DEFAULT NULL,
  `pe` varchar(11) DEFAULT NULL,
  `ane` varchar(6) DEFAULT NULL,
...
INSERT INTO `tbl_name` (`age`, `bp`, `sg`, `al`, `su`, `rbc`, `pc`, `pcc`, `ba`, `bgr`, `bu`, `sc`, `sod`, `pot`, `hemo`, `pcv`, `wc`, `rc`, `htn`, `dm`, `cad`, `appet`, `pe`, `ane`, `class`, `class1`) VALUES
...
('21', '70', '1.01', '0', '0', '?', 'normal', 'notpresent', 'notpresent', '?', '?', '?', '?', '?', '?', '?', '?', '?', 'no', 'no', 'no', 'poor', 'no', 'yes', 'ckd', ''),
...
('55', '80', '1.01', '0', '0', '?', 'normal', 'notpresent', 'notpresent', '146', '?', '?', '?', '?', '9.8', '?', '?', '?', 'no', 'no', '', 'no', 'good', 'no', 'no', 'ckd'),
...
('45', '80', '1.02', '3', '0', 'normal', 'abnormal', 'notpresent', 'notpresent', '425', '?', '?', '?', '?', '?', '?', '?', '?', 'no', 'no', 'no', 'poor', 'no', 'no', 'ckd', ''),
...
('?', '70', '1.02', '0', '0', '?', '?', 'notpresent', 'notpresent', '219', '36', '1.3', '139', '3.7', '12.5', '37', '9800', '4.4', 'no', 'no', 'no', 'good', 'no', 'no', 'ckd', ''),
...
('73', '?', '1.01', '1', '0', '?', '?', 'notpresent', 'notpresent', '95', '51', '1.6', '142', '3.5', '?', '?', '?', '?', 'no', '', 'no', 'no', 'good', 'no', 'no', 'ckd'),
...
('60', '80', '1.02', '0', '2', '?', '?', 'notpresent', 'notpresent', '?', '?', '?', '?', '?', '?', '?', '?', '?', 'no', 'yes', 'no', 'good', 'no', 'no', 'ckd', ''),
...
('?', '70', '1.01', '0', '2', '?', 'normal', 'notpresent', 'notpresent', '220', '68', '2.8', '?', '?', '8.7', '27', '?', '?', 'yes', 'yes', 'no', 'good', 'no', 'yes', 'ckd', ''),
...
('4', '?', '1.02', '1', '0', '?', 'normal', 'notpresent', 'notpresent', '99', '23', '0.6', '138', '4.4', '12', '34', '', '?', '?', 'no', 'no', 'no', 'good', 'no', 'no', 'ckd'),
('8', '50', '1.02', '4', '0', 'normal', 'normal', 'notpresent', 'notpresent', '?', '46', '1', '135', '3.8', '?', '?', '?', '?', 'no', 'no', 'no', 'good', 'yes', 'no', 'ckd', ''),
('3', '?', '1.01', '2', '0', 'normal', 'normal', 'notpresent', 'notpresent', '?', '22', '0.7', '?', '?', '10.7', '34', '12300', '?', 'no', 'no', 'no', 'good', 'no', 'no', 'ckd', ''),
...
('?', '70', '1.01', '3', '0', 'normal', 'normal', 'notpresent', 'notpresent', '110', '115', '6', '134', '2.7', '9.1', '26', '9200', '3.4', 'yes', 'yes', 'no', 'poor', 'no', 'no', 'ckd', ''),
...
('19', '70', '1.02', '0', '0', '?', 'normal', 'notpresent', 'notpresent', '?', '?', '?', '?', '?', '11.5', '?', '6900', '?', 'no', 'no', 'no', 'good', 'no', 'no', 'ckd', ''),
...
('2', '?', '1.01', '3', '0', 'normal', 'abnormal', 'notpresent', 'notpresent', '?', '?', '?', '?', '?', '?', '?', '?', '?', 'no', 'no', 'no', 'good', 'yes', 'no', 'ckd', ''),
('64', '70', '1.01', '0', '0', '?', 'normal', 'notpresent', 'notpresent', '107', '15', '?', '?', '?', '12.8', '38', '?', '?', 'no', 'no', 'no', 'good', 'no', 'no', 'ckd', ''),
...
('36', '80', '1.01', '0', '0', '?', 'normal', 'notpresent', 'notpresent', '103', '?', '?', '?', '?', '11.9', '36', '8800', '?', 'no', 'no', 'no', 'good', 'no', 'no', 'ckd', ''),
...
('?', '80', '?', '?', '?', '?', '?', 'notpresent', 'notpresent', '100', '49', '1', '140', '5', '16.3', '53', '8500', '4.9', 'no', 'no', 'no', 'good', 'no', 'no', 'notckd', '');
INSERT INTO `tbl_name` (`age`, `bp`, `sg`, `al`, `su`, `rbc`, `pc`, `pcc`, `ba`, `bgr`, `bu`, `sc`, `sod`, `pot`, `hemo`, `pcv`, `wc`, `rc`, `htn`, `dm`, `cad`, `appet`, `pe`, `ane`, `class`, `class1`) VALUES
...
('20', '60', '1.025', '0', '0', 'normal', 'normal', 'notpresent', 'notpresent', '?', '?', '?', '137', '4.7', '14', '41', '4500', '5.5', 'no', 'no', 'no', 'good', 'no', 'no', 'notckd', ''),
...
('60', '70', '1.02', '0', '0', 'normal', 'normal', 'notpresent', 'notpresent', '?', '?', '?', '?', '?', '16.4', '43', '10800', '5.7', 'no', 'no', 'no', 'good', 'no', 'no', 'notckd', ''),
...
('50', '?', '1.02', '0', '0', 'normal', 'normal', 'notpresent', 'notpresent', '92', '19', '1.2', '150', '4.8', '14.9', '48', '4700', '5.4', 'no', 'no', 'no', 'good', 'no', 'no', 'notckd', ''),
...
('53', '60', '1.025', '0', '0', 'normal', 'normal', 'notpresent', 'notpresent', '116', '26', '1', '146', '4.9', '15.8', '45', '7700', '5.2', '?', '?', '?', 'good', 'no', 'no', 'notckd', ''),
...
('80', '70', '1.02', '0', '0', 'normal', 'normal', 'notpresent', 'notpresent', '?', '?', '?', '135', '4.1', '15.3', '48', '6300', '6.1', 'no', 'no', 'no', 'good', 'no', 'no', 'notckd', ''),
...
('35', '?', '1.02', '0', '0', 'normal', 'normal', '?', '?', '99', '30', '0.5', '135', '4.9', '15.4', '48', '5000', '5.2', 'no', 'no', 'no', 'good', 'no', 'no', 'notckd', ''),
